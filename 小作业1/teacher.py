...
url = "https://sdmda.bupt.edu.cn/szdw/js1.htm"
...
csvfile = open("teacher.csv", mode = "w", newline = "")
fieldnames = ["Department", "Name", "Title", "Photo"]
write = csv.DictWriter(csvfile, fieldnames=fieldnames)
write.writeheader()
for i in range(0, len(infor), 2):
    write.writerow({"Department":infor[i+1], "Name":infor[i], "Title":"讲师", "Photo":filenames[int(i/2)]})